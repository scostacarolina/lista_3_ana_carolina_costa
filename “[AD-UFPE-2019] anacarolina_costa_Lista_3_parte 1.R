...
#abrindo descrição da base de dados#
str(mtcars)

#São 32 observações reunidas em 11 variavéis numéricas#

# visualizar dimensão da base de dados#
dim(mtcars)
#[1] 32 11#

#visualizar quais são as variavéis numéricas#

names(mtcars)

##São elas: "mpg"  "cyl"  "disp" "hp"   "drat" "wt"   "qsec" "vs"   "am"   "gear" "carb" ##
...
#apresente a média do número de matrículas#
...
docentes <- as.data.frame(docentes)
